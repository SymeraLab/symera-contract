...
/**
 * @title The primary 'slashing' contract for Symera.
 * @author Symera, Inc.
...
contract Slasher is Initializable, OwnableUpgradeable, ISlasher, Pausable {
    ...
    /// @notice The central SlotManager contract of Symera
    ISlotManager public immutable slotManager;
    /// @notice The DelegationManager contract of Symera
    ...
    /// @notice Emitted when `previouslySlashedAddress` is 'unfrozen', allowing them to again move deposited funds within Symera.
    event FrozenStatusReset(address indexed previouslySlashedAddress);

    constructor(ISlotManager _slotManager, IDelegationManager _delegation) {
    ...
    */
     ...
     * slashing of their funds, and cannot cannot deposit or withdraw from the slotManager until the slashing process is completed
